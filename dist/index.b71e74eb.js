...
const STRIDE = 8; // vec3 position + padding, vec3 velocity + padding
...
for(let entity = 0; entity < ENTITIES_COUNT; entity++){
    ...
    entityData[entity * STRIDE + 4] = (Math.random() - 0.5) * 0.2; // velocity.x
    entityData[entity * STRIDE + 5] = (Math.random() - 0.5) * 0.2; // velocity.y
    entityData[entity * STRIDE + 6] = (Math.random() - 0.5) * 0.2; // velocity.z
}
const setupRenderer = ()=>{
...
const compute = async ()=>{
    ...
    performance.measure("compute.duration", "compute.start", "compute.end").duration;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","bundle-text:./compute-shader.wgsl":"4NDR6"}],"gkKU3":[function(require,module,exports) {
